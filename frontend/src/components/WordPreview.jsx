        ...
        {blocks.map((block, idx) =>
          block.type === 'table' ? (
            ...
            <ReactMarkdown
              ...
              components={{
                h1: ({ children }) => (
                  <h1 className="text-[18px] font-bold text-(--bleu-active) mt-6 mb-2 border-b-2 border-(--bleu-active) pb-1">
                    {children}
                  </h1>
                ),
                h2: ({ children }) => (
                ...
                hr: () => (
                  <hr className="my-5 border-t-2 border-(--bleu-active) opacity-40" />
                ),
                blockquote: ({ children }) => (
                  <blockquote className="border-l-4 border-(--bleu-active) pl-4 italic text-[#555] my-3 bg-[#f0f7ff] py-2 pr-3 rounded-r-md">
                    {children}
                  </blockquote>
                ),
              }}
