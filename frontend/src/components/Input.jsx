...
const fieldClass =
  'w-full px-3 py-2 md:px-4 md:py-2.5 rounded-lg border border-(--border) bg-(--bg-secondary) text-(--text-primary) placeholder-(--text-muted) focus:outline-none focus:ring-2 focus:ring-[#1294C3] focus:border-transparent transition-shadow text-xs md:text-sm lg:text-base placeholder:text-xs md:placeholder:text-sm lg:placeholder:text-base disabled:opacity-50 disabled:cursor-not-allowed';
